...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-05-2021 a las 19:11:31
...
--
-- Base de datos: `bd-restaurante`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl-dorecciones`
--

CREATE TABLE `tbl-dorecciones` (
...
--
-- Indices de la tabla `tbl-dorecciones`
--
ALTER TABLE `tbl-dorecciones`
...
--
-- AUTO_INCREMENT de la tabla `tbl-dorecciones`
--
ALTER TABLE `tbl-dorecciones`
